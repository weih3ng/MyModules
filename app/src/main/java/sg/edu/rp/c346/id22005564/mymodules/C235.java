...
public class C235 extends AppCompatActivity {
    TextView TextView;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_c235);
        ...
        String code = intentReceived.getStringExtra("C235");
        TextView.setText("Module Code: C235 \nModule Name: IT Security \nAcademic Year: " + value +
                "\nSemester: " + sem + "\nModule Credit: " + cred +"\nVenue: W64N");
